...
class DataBaseOperation:
    ...
    def create_table(self,database_name,table_name,column_name):
        try:
            ...
            self.logger.info("Exception raise while creating table: %s " %e)
            raise e
    ...
    def insert_data(self,database_name,table_name):
        ...
        self.logger.info("Start inserting files in table")
